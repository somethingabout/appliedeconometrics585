...
## add how to standardize without replacing vectors
...
The null hypothesis $H_0 : \beta_3 = 0$ is the same as saying the partial effects are constant. It should be tested. If it cannot be rejected at a small significance level (smaller than 5%), it is not worth complicating the model.
