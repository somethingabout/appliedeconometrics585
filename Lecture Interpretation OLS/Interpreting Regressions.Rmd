...
$.016 (10) =1.6$ percent increase in salary. 
...
```
In this case, the intercept is 822.35 million dollars.  Leaving it in log units is kind of strange, because what are log units? Much better to exponentiate it to convert it back to understandable units.
...
### Policy Analysis and the Self-Selection Problem
...
For every unit $i$ in the sample, predict $y_{i} (0)$ and $y_{i} (1)$ regardless of whether the unit was in the control of treatment group
