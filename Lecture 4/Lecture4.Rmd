...
---
We've discussed the OLS Assumptions up until this point:
...
Last class we talked about inference and issues with inference when dealing with the standard errors of our parameters. 
...
Can the adjusted $R^2$ ever be negative?

What happens if we include an irrelavant variable? Let's see an example...
...
This means that we can "relax" the assumption of normality with tcaveate that testing is *approximate* with large samples.  
